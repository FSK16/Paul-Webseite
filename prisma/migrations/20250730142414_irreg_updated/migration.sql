/*
  ...
  - You are about to drop the column `line` on the `IrregularStation` table. All the data in the column will be lost.
...
INSERT INTO "new_IrregularStation" ("added", "stationID", "stationName") SELECT "added", "stationID", "stationName" FROM "IrregularStation";
